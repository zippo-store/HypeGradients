...
public class GuiSlotMessagePacket extends MessagePacket {

    public GuiSlotMessagePacket(JavaPlugin plugin, MessagePacketConfigurations configurations, ListenerPriority priority, PacketType type, MessageType messageType) {
